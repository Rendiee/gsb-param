    ...
    <div class="mt-md-2 pb-3">
        ...
        <form action="index.php?uc=administrer&action=editerProduit" method="POST" id="formEditProduct">
            ...
            <div class="button-form-center mt-3">
                <input class="btn btn-success px-5" type="submit" value="Editer" name="chooseproduct" id="chooseproduct">
            </div>
            <div class="button-form-center mt-3">
                <input class="btn btn-success px-3" type="submit" value="Ajouter une contenance" name="addContenance" id="addContenance">
            </div>
            <div class="button-form-center mt-3">
                <input onclick="return confirm('Êtes vous sûr de vouloir supprimer le produit et toutes ses contenances ?');" class="btn btn-outline-danger px-3" type="submit" value="Supprimer" name="suppProduit" id="suppProduit">
            </div>
        </form>
    </div>
</div>