<form class="w-75 m-auto" method="POST" action="index.php?uc=voirProduits&produit=<?php echo $id ?>&action=voirLeProduit">
        ...
        <div class="border-start d-flex flex-column justify-content-between pt-3">
            <div class="p-2">
                ...
                <div class="d-flex flex-column align-items-start justify-content-center col-md-8 col-12 mx-auto">
                    <div class=""><?php echo $prixMin[0] . '€ - ' . $prixMax[0] . '€' ?></div>
                    <div class="d-flex justify-content-start align-items-center pt-2">
                        <div class="text-center me-1">Contenance : </div>
                        <select class="form-select border-success rounded fit" id="list-prix" name="list-prix" onchange="checkStock(); checkContenance();">
                            <?php
